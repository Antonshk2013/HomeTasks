...
/*0 результатов, условия перекрывают диапозоны друг друга по salary*/
  Детально
  Просят вывести строки где зароботная плата и больше 10000 и меньше 5000 одновременно, условия ссылаются на один
  атрибут  salary, при этом должны быть выполненны 2 условия которые противаречат друг другу
  В первом ответе я наверное не доконца првавильно выразился, не перекрывают.
  Если абстрактно представить выборку с 1 условием в виде круга, и второе тоже, то выборка будет пересечением кругов.
  Так вот круги не пересекаются соответственно не будет выведено ни одной записи
    Как то так
  */
