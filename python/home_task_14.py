...
пользователь не введет команду "Выход". 
...
def list_numbers():
    new_list = []
    while True:
        answer = input("Введите число (или 'Выход' для завершения):")
        if answer == "Выход":
            return new_list
        new_list.append(int(answer))


if __name__ == '__main__':
    print(naoborot("Программирование это интересно и полезно"))
    print(list_numbers())
